<section>
    ...
    <form method="post" action="{{ route('project.update', $project) }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" :value="old('description',  $project->description)" required autocomplete="description" />
        </div>
